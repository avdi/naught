...
RSpec.describe Naught do
  describe "null object impersonating another type" do
    ...
    let(:impersonation_class) do
      described_class.build do |b|
        b.impersonate NaughtSpecFixtures::Point
      end
    end

    it "matches the impersonated type" do
      expect(null).to be_a NaughtSpecFixtures::Point
    end

    it "responds to x method from the impersonated type" do
      expect(null.x).to be_nil
    end

    it "responds to y method from the impersonated type" do
  ...
  describe "traceable null object" do
    ...
    let(:trace_null_class) do
      described_class.build(&:traceable)
    end
